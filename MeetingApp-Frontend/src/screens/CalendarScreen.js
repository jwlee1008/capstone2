  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.sectionHeaderRow}><Text style={styles.sectionTitle}>일정</Text><TouchableOpacity style={styles.smallAddBtn} onPress={() => setShowEventForm((prev) => !prev)} activeOpacity={0.8}><Ionicons name={showEventForm ? 'close' : 'add'} size={15} color={COLORS.primary} /><Text style={styles.smallAddText}>{showEventForm ? '닫기' : '추가'}</Text></TouchableOpacity></View>
        {showEventForm ? <View style={styles.dayCard}>
        ...
        <Text style={[styles.sectionTitle, styles.sectionTitleStandalone]}>등록된 할일</Text>
...
const styles = StyleSheet.create({ safeArea: { flex: 1, backgroundColor: COLORS.background }, scrollContent: { paddingHorizontal: 20, paddingTop: 16, paddingBottom: 40 }, header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }, headerTitle: { fontSize: 24, fontWeight: '700', color: COLORS.text, letterSpacing: 0 }, headerBadge: { backgroundColor: '#EFF6FF', borderRadius: 10, paddingHorizontal: 10, paddingVertical: 5 }, headerBadgeText: { color: COLORS.primary, fontWeight: '700', fontSize: 12 }, notionCard: { backgroundColor: COLORS.surface, borderRadius: 16, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: COLORS.border, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 5, elevation: 2 }, notionTop: { flexDirection: 'row', alignItems: 'center', gap: 12 }, notionIconWrap: { width: 42, height: 42, borderRadius: 12, backgroundColor: '#EFF6FF', alignItems: 'center', justifyContent: 'center' }, notionTitle: { fontSize: 15, fontWeight: '700', color: COLORS.text }, notionDesc: { fontSize: 12, color: COLORS.subtext, lineHeight: 18, marginTop: 3 }, notionBtn: { marginTop: 14, height: 44, borderRadius: 12, backgroundColor: COLORS.primary, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, notionBtnConnected: { backgroundColor: COLORS.secondary }, notionBtnText: { color: '#FFFFFF', fontWeight: '700', fontSize: 14 }, statsRow: { flexDirection: 'row', gap: 8, marginBottom: 18 }, statBox: { flex: 1, backgroundColor: COLORS.surface, borderRadius: 12, paddingVertical: 10, alignItems: 'center', borderWidth: 1, borderColor: COLORS.border }, statValue: { color: COLORS.text, fontSize: 18, fontWeight: '700' }, statLabel: { color: COLORS.subtext, fontSize: 10, marginTop: 2 }, sectionHeaderRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 8, marginBottom: 12 }, sectionTitle: { fontSize: 17, fontWeight: '700', color: COLORS.text }, sectionTitleStandalone: { marginTop: 8, marginBottom: 12 }, smallAddBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#EFF6FF', borderRadius: 9, paddingHorizontal: 10, paddingVertical: 6 }, smallAddText: { color: COLORS.primary, fontSize: 12, fontWeight: '700' }, input: { backgroundColor: COLORS.inputBg, borderRadius: 10, height: 42, paddingHorizontal: 12, color: COLORS.text, marginBottom: 8 }, formRow: { flexDirection: 'row', gap: 8 }, formInput: { flex: 1 }, timeInput: { width: 70 }, addBtn: { height: 42, borderRadius: 11, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center' }, addBtnText: { color: '#FFFFFF', fontWeight: '700', fontSize: 14 }, emptyCard: { backgroundColor: COLORS.surface, borderRadius: 16, padding: 32, alignItems: 'center', borderWidth: 1, borderColor: COLORS.border }, emptySlim: { backgroundColor: COLORS.surface, borderRadius: 16, padding: 18, marginBottom: 12, borderWidth: 1, borderColor: COLORS.border }, emptyTitle: { fontSize: 16, fontWeight: '700', color: COLORS.subtext, marginTop: 4 }, emptyDesc: { fontSize: 12, color: '#A0AEC0', lineHeight: 18, textAlign: 'center', marginTop: 6 }, dayCard: { backgroundColor: COLORS.surface, borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: COLORS.border, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 4, elevation: 1 }, dayHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }, dayTitle: { fontSize: 15, fontWeight: '700', color: COLORS.primary }, dayCount: { fontSize: 12, color: COLORS.subtext, fontWeight: '600' }, eventRow: { flexDirection: 'row', alignItems: 'center', gap: 10 }, taskItem: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, paddingVertical: 10, borderTopWidth: 1, borderTopColor: '#F3F4F6' }, taskDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: COLORS.success, marginTop: 5 }, taskTitle: { fontSize: 13, fontWeight: '700', color: COLORS.text }, taskMeta: { fontSize: 11, color: COLORS.subtext, marginTop: 3 }, statusRow: { flexDirection: 'row', gap: 5, marginTop: 7 }, statusBtn: { borderRadius: 7, paddingHorizontal: 7, paddingVertical: 3, backgroundColor: COLORS.inputBg }, statusBtnActive: { backgroundColor: '#EFF6FF' }, statusBtnText: { fontSize: 10, color: COLORS.subtext, fontWeight: '700' }, statusBtnTextActive: { color: COLORS.primary }, deleteBtn: { width: 30, height: 30, borderRadius: 8, backgroundColor: '#FEF2F2', alignItems: 'center', justifyContent: 'center' } });
