...
const styles = StyleSheet.create({
  ...
  meetingMainButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: COLORS.surface, borderRadius: 16, padding: 16, marginBottom: 18, borderWidth: 1, borderColor: COLORS.border, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 5, elevation: 2 }, meetingMainButtonDisabled: { opacity: 0.55 }, meetingMainLeft: { flexDirection: 'row', alignItems: 'center', flex: 1 }, meetingMainIconWrap: { width: 48, height: 48, borderRadius: 13, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center', marginRight: 14 }, meetingMainTextWrap: { flex: 1 }, meetingMainTitle: { fontSize: 18, fontWeight: '700', color: COLORS.text, letterSpacing: 0 }, meetingMainDesc: { fontSize: 12, color: COLORS.subtext, marginTop: 3 },
