    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsRow}>
          ...
          <Stat icon="checkmark-circle-outline" bg={COLORS.successSoft} color={COLORS.success} value={totalSessions} label="완료 세션" />
          <Stat icon="calendar-outline" bg={COLORS.warningSoft} color={COLORS.warning} value={calendarTasks.length + calendarEvents.length} label="할일/일정" />
        </View>
...
const styles = StyleSheet.create({
  ...
  workspaceCard: { backgroundColor: COLORS.surface, borderRadius: RADIUS.xl, padding: 18, marginBottom: 18, borderWidth: 1, borderColor: COLORS.border, ...CARD_SHADOW }, workspaceIconWrap: { width: 44, height: 44, borderRadius: RADIUS.md, backgroundColor: COLORS.chip, alignItems: 'center', justifyContent: 'center', marginBottom: 12 }, workspaceHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }, workspaceLabel: { fontSize: 11, fontWeight: '700', color: COLORS.primary, marginBottom: 3 }, workspaceTitle: { fontSize: 18, fontWeight: '700', color: COLORS.text }, workspaceDesc: { fontSize: 13, color: COLORS.subtext, lineHeight: 19, marginTop: 6, marginBottom: 14 },
  inputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.inputBg, borderRadius: RADIUS.md, borderWidth: 1.5, borderColor: 'transparent', paddingHorizontal: 12, height: 48 }, input: { flex: 1, color: COLORS.text, fontSize: 14 }, createWorkspaceBtn: { height: 50, borderRadius: RADIUS.md, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center', marginTop: 12 }, createWorkspaceText: { color: '#FFFFFF', fontWeight: '700', fontSize: 15 },
  createWorkspaceRow: { flexDirection: 'row', gap: 8, marginTop: 12, marginBottom: 12 }, createWorkspaceInput: { flex: 1 }, createWorkspaceIconBtn: { width: 48, height: 48, borderRadius: RADIUS.md, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center' },
  memberBadge: { backgroundColor: COLORS.chip, borderRadius: RADIUS.sm, paddingHorizontal: 10, paddingVertical: 5 }, memberBadgeText: { color: COLORS.chipText, fontWeight: '700', fontSize: 12 }, memberRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 14 }, memberChip: { backgroundColor: COLORS.inputBg, borderRadius: RADIUS.sm, paddingHorizontal: 10, paddingVertical: 6 }, memberChipText: { color: COLORS.text, fontWeight: '600', fontSize: 12 }, noMemberText: { color: COLORS.subtext, fontSize: 12 }, inviteRow: { flexDirection: 'row', gap: 8, marginTop: 14 }, inviteInputWrap: { flex: 1 }, inviteBtn: { width: 48, height: 48, borderRadius: RADIUS.md, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center' }, actionDisabled: { opacity: 0.6 }, invitedText: { fontSize: 12, color: COLORS.subtext, marginTop: 8 },
  currentWorkspacePanel: { backgroundColor: COLORS.panel, borderRadius: RADIUS.lg, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: COLORS.border }, currentWorkspaceName: { fontSize: 20, fontWeight: '700', color: COLORS.text },
  workspaceActions: { flexDirection: 'row', gap: 8, marginTop: 14 }, primaryActionBtn: { flex: 1, height: 46, borderRadius: RADIUS.md, backgroundColor: COLORS.primary, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, primaryActionText: { color: '#FFFFFF', fontWeight: '700', fontSize: 14 }, secondaryActionBtn: { height: 46, borderRadius: RADIUS.md, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, paddingHorizontal: 16, alignItems: 'center', justifyContent: 'center' }, secondaryActionText: { color: COLORS.text, fontWeight: '700', fontSize: 13 },
  emptyWorkspaceBox: { backgroundColor: COLORS.panel, borderRadius: RADIUS.md, padding: 14, borderWidth: 1, borderColor: COLORS.border }, emptyWorkspaceText: { color: COLORS.subtext, fontSize: 13 },
  workspaceGrid: { gap: 8 },
  workspaceListItem: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 12, paddingHorizontal: 12, borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.md, backgroundColor: COLORS.surface },
  ...
  declineBtn: { backgroundColor: COLORS.inputBg, borderRadius: RADIUS.xs, paddingHorizontal: 9, paddingVertical: 6 },
  ...
  noticeBanner: { backgroundColor: COLORS.chip, borderRadius: RADIUS.md, padding: 14, marginBottom: 24, borderWidth: 1, borderColor: COLORS.border }, noticeLeft: { flexDirection: 'row', alignItems: 'center', gap: 10 }, noticeBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.secondary, borderRadius: RADIUS.xs, paddingHorizontal: 8, paddingVertical: 4, gap: 3 }, noticeBadgeText: { color: '#FFFFFF', fontSize: 11, fontWeight: '700' }, noticeTitle: { fontSize: 14, fontWeight: '700', color: COLORS.text }, noticeDesc: { fontSize: 11, color: COLORS.subtext, marginTop: 1 },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }, sectionTitle: { fontSize: 17, fontWeight: '700', color: COLORS.text, marginBottom: 12 }, seeAllText: { fontSize: 13, color: COLORS.primary, fontWeight: '600' }, emptyCard: { backgroundColor: COLORS.surface, borderRadius: RADIUS.lg, padding: 32, alignItems: 'center', marginBottom: 24, borderWidth: 1, borderColor: COLORS.border }, emptyText: { fontSize: 15, fontWeight: '600', color: COLORS.subtext, marginTop: 12 }, emptySubtext: { fontSize: 12, color: COLORS.placeholder, marginTop: 4, textAlign: 'center' }, recentMeetingCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: COLORS.surface, borderRadius: RADIUS.lg, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: COLORS.border, ...CARD_SHADOW }, recentCardLeft: { flexDirection: 'row', alignItems: 'center', flex: 1, gap: 12 }, recentAvatarCircle: { width: 44, height: 44, borderRadius: RADIUS.md, backgroundColor: COLORS.chip, alignItems: 'center', justifyContent: 'center' }, recentAvatarText: { fontSize: 18, fontWeight: '700', color: COLORS.primary }, recentMeetingName: { fontSize: 15, fontWeight: '600', color: COLORS.text }, recentMeetingMeta: { fontSize: 12, color: COLORS.subtext, marginTop: 2 }, sessionCountBadge: { backgroundColor: COLORS.chip, borderRadius: RADIUS.xs, paddingHorizontal: 10, paddingVertical: 4 }, sessionCountText: { fontSize: 12, fontWeight: '700', color: COLORS.chipText },
});
