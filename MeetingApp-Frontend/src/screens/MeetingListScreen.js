    ...
    <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.78}>
      <View style={styles.cardLeft}>
        ...
        <View style={styles.cardContent}>
          ...
          {latestSession && <View style={[styles.latestSessionBadge, latestSession.processStatus !== 'done' && styles.latestSessionBadgePending]}><Ionicons name="document-text-outline" size={10} color={latestSession.processStatus === 'done' ? COLORS.success : COLORS.warning} /><Text style={[styles.latestSessionText, latestSession.processStatus !== 'done' && styles.latestSessionTextPending]}>최근: {latestSession.processStatus === 'done' ? '기록 정리 완료' : '기록 정리중'}</Text></View>}
        </View>
      </View>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: COLORS.background }, workspaceHeader: { backgroundColor: COLORS.surface, paddingHorizontal: 16, paddingTop: 14, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: COLORS.border }, headerLabel: { fontSize: 11, fontWeight: '800', color: COLORS.primary, marginBottom: 3 }, headerTitle: { fontSize: 18, fontWeight: '800', color: COLORS.text }, workspaceList: { flexDirection: 'row', flexWrap: 'wrap', gap: 7, marginTop: 10 }, workspaceChip: { maxWidth: '48%', borderRadius: 8, backgroundColor: COLORS.inputBg, paddingHorizontal: 10, paddingVertical: 7 }, workspaceChipActive: { backgroundColor: COLORS.chip, borderWidth: 1, borderColor: COLORS.primary }, workspaceChipText: { fontSize: 12, color: COLORS.subtext, fontWeight: '800' }, workspaceChipTextActive: { color: COLORS.primary }, searchContainer: { paddingHorizontal: 16, paddingVertical: 12, backgroundColor: COLORS.surface, borderBottomWidth: 1, borderBottomColor: COLORS.border }, searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.inputBg, borderRadius: 8, paddingHorizontal: 12, height: 42, gap: 8 }, searchInput: { flex: 1, fontSize: 14, color: COLORS.text }, sortRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 10 }, sortLabel: { fontSize: 13, color: COLORS.subtext, fontWeight: '600' }, sortCount: { color: COLORS.primary, fontWeight: '800' }, sortBtnGroup: { flexDirection: 'row', gap: 6 }, sortBtn: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 7, backgroundColor: COLORS.inputBg }, sortBtnActive: { backgroundColor: COLORS.chip }, sortBtnText: { fontSize: 11, color: COLORS.subtext, fontWeight: '700' }, sortBtnTextActive: { color: COLORS.primary, fontWeight: '800' }, listContent: { paddingHorizontal: 16, paddingTop: 4, paddingBottom: 100 }, card: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', backgroundColor: COLORS.surface, borderRadius: 8, padding: 15, borderWidth: 1, borderColor: COLORS.border }, cardLeft: { flexDirection: 'row', flex: 1, gap: 12 }, cardAvatar: { width: 46, height: 46, borderRadius: 8, backgroundColor: COLORS.chip, alignItems: 'center', justifyContent: 'center' }, cardAvatarText: { fontSize: 19, fontWeight: '800', color: COLORS.primary }, cardContent: { flex: 1, gap: 3 }, cardTitle: { fontSize: 15, fontWeight: '800', color: COLORS.text, marginBottom: 2 }, cardMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 4 }, cardMeta: { fontSize: 12, color: COLORS.subtext, flexShrink: 1 }, latestSessionBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#ECFDF5', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 3, marginTop: 4, gap: 4, alignSelf: 'flex-start' }, latestSessionBadgePending: { backgroundColor: '#FEF3C7' }, latestSessionText: { fontSize: 10, color: COLORS.success, fontWeight: '700' }, latestSessionTextPending: { color: COLORS.warning }, cardRight: { alignItems: 'center', marginLeft: 8 }, sessionBadge: { alignItems: 'center', backgroundColor: COLORS.chip, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6 }, sessionBadgeText: { fontSize: 17, fontWeight: '800', color: COLORS.primary }, sessionBadgeLabel: { fontSize: 9, color: COLORS.primary, fontWeight: '700' }, emptyContainer: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32 }, emptyTitle: { fontSize: 18, fontWeight: '800', color: COLORS.subtext, marginTop: 16 }, emptyDesc: { fontSize: 13, color: COLORS.muted, textAlign: 'center', marginTop: 6 }, fab: { position: 'absolute', bottom: 24, right: 20, width: 54, height: 54, borderRadius: 27, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.14, shadowRadius: 7, elevation: 5 }, fabDisabled: { opacity: 0.55 },
});
