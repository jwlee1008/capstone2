...
export default function MeetingListScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['bottom']}>
      ...
      <View style={styles.searchContainer}><View style={styles.searchBar}><Ionicons name="search-outline" size={16} color={COLORS.subtext} /><TextInput style={styles.searchInput} placeholder="회의 이름, 멤버 검색..." placeholderTextColor={COLORS.placeholder} value={searchQuery} onChangeText={setSearchQuery} />{searchQuery.length > 0 && <TouchableOpacity onPress={() => setSearchQuery('')}><Ionicons name="close-circle" size={16} color={COLORS.subtext} /></TouchableOpacity>}</View></View>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: COLORS.background }, workspaceHeader: { backgroundColor: COLORS.surface, paddingHorizontal: 16, paddingTop: 14, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: COLORS.border }, headerLabel: { fontSize: 11, fontWeight: '700', color: COLORS.primary, marginBottom: 3 }, headerTitle: { fontSize: 18, fontWeight: '700', color: COLORS.text }, workspaceList: { flexDirection: 'row', flexWrap: 'wrap', gap: 7, marginTop: 10 }, workspaceChip: { maxWidth: '48%', borderRadius: RADIUS.sm, backgroundColor: COLORS.inputBg, paddingHorizontal: 10, paddingVertical: 7 }, workspaceChipActive: { backgroundColor: COLORS.chip, borderWidth: 1, borderColor: COLORS.primary }, workspaceChipText: { fontSize: 12, color: COLORS.subtext, fontWeight: '700' }, workspaceChipTextActive: { color: COLORS.chipText }, searchContainer: { paddingHorizontal: 16, paddingVertical: 12, backgroundColor: COLORS.surface, borderBottomWidth: 1, borderBottomColor: COLORS.border }, searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.inputBg, borderRadius: RADIUS.md, paddingHorizontal: 12, height: 42, gap: 8 }, searchInput: { flex: 1, fontSize: 14, color: COLORS.text }, sortRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 10 }, sortLabel: { fontSize: 13, color: COLORS.subtext, fontWeight: '500' }, sortCount: { color: COLORS.primary, fontWeight: '700' }, sortBtnGroup: { flexDirection: 'row', gap: 6 }, sortBtn: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: RADIUS.xs, backgroundColor: COLORS.inputBg }, sortBtnActive: { backgroundColor: COLORS.chip }, sortBtnText: { fontSize: 11, color: COLORS.subtext, fontWeight: '500' }, sortBtnTextActive: { color: COLORS.chipText, fontWeight: '700' }, listContent: { paddingHorizontal: 16, paddingTop: 4, paddingBottom: 100 }, card: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', backgroundColor: COLORS.surface, borderRadius: RADIUS.lg, padding: 16, borderWidth: 1, borderColor: COLORS.border, ...CARD_SHADOW }, cardLeft: { flexDirection: 'row', flex: 1, gap: 12 }, cardAvatar: { width: 48, height: 48, borderRadius: RADIUS.md, backgroundColor: COLORS.chip, alignItems: 'center', justifyContent: 'center' }, cardAvatarText: { fontSize: 20, fontWeight: '700', color: COLORS.primary }, cardContent: { flex: 1, gap: 3 }, cardTitle: { fontSize: 15, fontWeight: '700', color: COLORS.text, marginBottom: 2 }, cardMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 4 }, cardMeta: { fontSize: 12, color: COLORS.subtext, flexShrink: 1 }, latestSessionBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.successSoft, borderRadius: RADIUS.xs, paddingHorizontal: 6, paddingVertical: 3, marginTop: 4, gap: 4, alignSelf: 'flex-start' }, latestSessionText: { fontSize: 10, color: COLORS.success, fontWeight: '500' }, cardRight: { alignItems: 'center', marginLeft: 8 }, sessionBadge: { alignItems: 'center', backgroundColor: COLORS.chip, borderRadius: RADIUS.sm, paddingHorizontal: 10, paddingVertical: 6 }, sessionBadgeText: { fontSize: 18, fontWeight: '700', color: COLORS.primary }, sessionBadgeLabel: { fontSize: 9, color: COLORS.primary, fontWeight: '600' }, emptyContainer: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32 }, emptyTitle: { fontSize: 18, fontWeight: '700', color: COLORS.subtext, marginTop: 16 }, emptyDesc: { fontSize: 13, color: COLORS.placeholder, textAlign: 'center', marginTop: 6 }, fab: { position: 'absolute', bottom: 24, right: 20, width: 56, height: 56, borderRadius: RADIUS.pill, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center', shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.35, shadowRadius: 12, elevation: 10 }, fabDisabled: { opacity: 0.55 },
});
